...
class Chatbot {
    ...
    initialize() {
            ...
            <div class="chat-box">
                <div class="chat-header">
                    ...
                    <div class="chat-actions">
                        <span class="share-chat" title="Share conversation"><i class="fas fa-share-alt"></i></span>
                ...
                <div class="theme-picker">
                    <div class="theme-option" data-theme="default" style="background-color: #ff5a6e;"></div>
                    <div class="theme-option" data-theme="blue" style="background-color: #3498db;"></div>
                    <div class="theme-option" data-theme="green" style="background-color: #2ecc71;"></div>
                    <div class="theme-option" data-theme="purple" style="background-color: #9b59b6;"></div>
                </div>
        ...
        this.shareButton = chatWidget.querySelector('.share-chat');
    ...
    toggleChat() {
        ...
        if (this.chatBox.classList.contains('active')) {
            this.input.focus();
            // On mobile, scroll to bottom when opening chat
            if (window.innerWidth <= 480) {
                this.messagesContainer.scrollTop = this.messagesContainer.scrollHeight;
            }
        } else {
            // Hide keyboard when closing chat on mobile
            if (window.innerWidth <= 480) {
                this.input.blur();
            }
    ...
    async sendMessage() {
        ...
        // Add processing class to chat input
        this.input.parentElement.classList.add('processing');
        ...
        try {
            ...
            this.isProcessing = false;
            this.input.parentElement.classList.remove('processing');
...
User message: ${message}`;
    ...
    changeTheme(theme) {
        ...
        this.chatBox.classList.remove('theme-default', 'theme-blue', 'theme-green', 'theme-purple');
        this.chatButton.classList.remove('theme-default', 'theme-blue', 'theme-green', 'theme-purple');
        
        // Add the selected theme class
        this.chatBox.classList.add(`theme-${theme}`);
        this.chatButton.classList.add(`theme-${theme}`);
    ...
    hideMediaUploadOverlay() { return; }
    handleFileSelect() { return; }
    handleImageUpload() { return; }
}
