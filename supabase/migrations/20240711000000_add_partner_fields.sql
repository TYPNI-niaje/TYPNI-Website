-- Migration to add partner-specific fields to profiles table

-- Add organization and partnership_type columns to profiles table
ALTER TABLE public.profiles 
ADD COLUMN organization TEXT,
ADD COLUMN partnership_type TEXT;

-- Update the handle_new_user function to include partner fields
