-- Debug and fix organization field mapping in handle_new_user function
...
BEGIN
  ...
  BEGIN
    ...
    RAISE NOTICE 'Processing user registration: %', new.raw_user_meta_data;
    RAISE NOTICE 'Organization value: %', new.raw_user_meta_data->>'organization';
    ...
    VALUES (
      ...
      END),
      -- Fixed organization field - ensure it's getting the right value
      (CASE
